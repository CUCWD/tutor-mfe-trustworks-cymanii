...
def load_about():
    about = {}
    with io.open(
        os.path.join(HERE, "tutormfe_trustworks_cymanii", "__about__.py"), "rt", encoding="utf-8"
    ) as f:
...
setup(
    name="tutor-mfe-trustworks-cymanii",
    ...
    entry_points={"tutor.plugin.v1": ["mfe-trustworks-cymanii = tutormfe_trustworks_cymanii.plugin"]},
    classifiers=[
